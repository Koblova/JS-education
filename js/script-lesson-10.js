...
let ar2 = ["hello", 777, true];// переменную обьявляем здесь!!!!
...
let ar3 = ["hello", 777, true, 1, 5, 8]; // переменную обьявляем здесь!!!!
...
function f5() {
  ...
  out5.innerHTML = ar4[0] + ar4[2] + ar4[3]
}
...
let ar6 = ["Alina", "Pisces", "17", "March"]

function f6() {
  let out6 = document.querySelector('.out-6')
  out6.innerHTML = ar6[0] + " " + ar6[1] + " " + ar6[2] + " " + ar6[3]
}
...
function f7() {
  ...
  q = 'turkey'
  w = 'vietnam'
  document.querySelector('.out-7').innerHTML = ar7 + "," + t + "," + q + "," + w
...
function f8() {
  ...
  let e = ar8[6]
  ar8[6] = 5
  document.querySelector('.out-8').innerHTML = ar8[3] + "-" + ar8[4] + "-" + ar8[6]
...
function f9() {
  //document.querySelector('.out-9').innerHTML = ar9[5]
...
function f10() {
  let q = ar10[0]
  let w = ar10[ar10.length - 1]
  document.querySelector('.out-10').innerHTML = q + w
...
let ar13 = ['test', 'west', 'list', 'class', 'best'];
  // q = ar13.indexOf("test")
  // w = ar13[0]
  // document.querySelector('.out-13').innerHTML = q + " " + w + " " ...
function f13() {
  let out13 = document.querySelector('.out-13');
    for (let i = 0; i < ar13.length; i++) {
      out13.innerHTML += ar13[i] + ' ' + i + ' ';
    }
}
